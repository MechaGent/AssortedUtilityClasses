...
class Sets
{
	...
	{
		private final HalfByteRadixMap<U> core;

		EntriesSet(HalfByteRadixMap<U> inCore)
		{
			this.core = inCore;
		}
	...
	static class StringKeyedEntriesSet<U> extends BaseSet<Entry<String, U>>
	{
		...
		StringKeyedEntriesSet(HalfByteRadixMap<U> inCore)
		{
			this.core = inCore;
		}
	...
	{
		private final HalfByteRadixMap<?> core;

		KeysSet(HalfByteRadixMap<?> inCore)
		{
			this.core = inCore;
		}
	...
	static class ValuesSet<U> extends BaseSet<U>
	{
		...
		ValuesSet(HalfByteRadixMap<U> inHalfByteRadixMapBase)
		{
			this.core = inHalfByteRadixMapBase;
		}
